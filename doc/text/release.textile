...
<pre>
$ rename -f "s/^_index.html/alphabetical_index.html/" doc/reference/**/_index.html
$ sed -i -e "s/_index.html/alphabetical_index.html/g" doc/reference/**/*.html
$ rake reference:publication:prepare
$ /bin/cp -r doc/html/（ライブラリ名）/* /path/to/ranguba.org/（ライブラリ名）
</pre>

TODO: index_html_dirを設定しているので、上記のコマンドをtaskにする。
